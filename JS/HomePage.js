...
document.getElementById("news-activities-h2").innerHTML = "News/Activites";
document.getElementById("news-activities-p").innerHTML = "Grace Bible Academy has activites planned for the year. The National Student Convention, the annual Sports Festival, etc. These activities will bring out the best in the students, all while they are having fun.";
document.getElementById("programs-h2").innerHTML = "Programs";
document.getElementById("programs-p").innerHTML = "Grace Bible Academy offers a variety of programs that students can select. Some of these are electives that are courses outside of the core curriculum that give students the opportunity to explore specific areas of study they are interested in. Grace Bible Academy highly encourages students to select at least one elective.";
